...
public class Room extends RoomBase {
	...
	public void company(String roomno, String floor,String connecting,String roomtype,String roomstatus) throws InterruptedException{
		
		driver.findElement(By.xpath("//*[@id='root']/div/main/div/div[2]/div/form/div[1]/div/input")).sendKeys(roomno);
